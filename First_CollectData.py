...
class CollectData:
    def __init__(self,self_kivy,profileloc,profilename):  
        ...
        #self.pA = vlc.MediaPlayer("C:\Users\MuhammadSalman\Desktop\Project_Source_Code\A.wmv")
        #self.pB = vlc.MediaPlayer("C:\Users\MuhammadSalman\Desktop\Project_Source_Code\B.wmv")
        self.choice = ''
        self.time = 1
            ...
            if self.readytocollect==True:
                ...
                if self.nSamplesTaken[0] == 128:
                    ...
                    if self.time>=1 and self.time<=5:
                        ...
                        self.self_kivy.lbl3.text = 'Please Take a Rest for 5 seconds'
                        
                        
                    elif self.time>=6 and self.time<=8:
                        self.self_kivy.text = os.getcwd()+'\\cue.png'
                        self.self_kivy.lbl3.text = 'Lets get ready for action in 3 seconds'
                        '''
                        if self.time == 8 and self.choice=='A':
                            self.pA.play()
                        elif self.time == 8 and self.choice == 'B':
                            self.pB.play()
                        '''
                        ...
                        self.self_kivy.lbl3.text = 'Lets think about showing action for 5 seconds' 
                        #self.self_kivy.text = ''
                        #if self.time==13:
                        #self.self_kivy.text = os.path.join(os.getcwd(),(self.choice+'.png'))
                        #self.self_kivy.text = os.getcwd()+'\\machine-learning.jpeg'
