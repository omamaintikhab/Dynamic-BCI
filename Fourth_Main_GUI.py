...
class TrainScreen(Screen):
    ...
    def change_lbl3(self):
        ...
        if checker == 1:
            self.cd.disconnect()
        self.lbl3.text = 'Processing your data & creating a ML Model'
...
class PredictScreen(Screen):
    ...
    def live_prediction(self,*args):
        ...
        #self.lbl4.text = 'Please First provide Neutral Thought Data for 20 seconds'
        self.cd.data_acq()
